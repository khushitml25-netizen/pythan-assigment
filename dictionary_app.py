...
def show_history():
    ...
    history_box.pack(padx=15, pady=10)
            ...
            for meaning in meanings:
                ...
                for definition in definitions:
                    ...
                    if example:
                        ...
                        if example not in examples_list:
